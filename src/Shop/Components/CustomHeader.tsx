...
export const CustomHeader = () => {
  ...
  //Esto guarda el Grid para que se mantenga en cada busquedsa 
  const query = searchParams.get('query') || '';
  //Esto es la funcion de la busqueda INPUT
  ...
  return (
    ...
    <header className="sticky top-0 z-50 w-full border-b backdrop-blur bg-slate-50">
      <div className="container mx-auto px-4 lg:px-8 h-18">
            ...
            <div className="hidden md:flex items-center space-x-2">
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-9 w-64 h-9 bg-cyan-100"
                  onKeyDown={hanldleSearch}
                  defaultValue={query}/>
              </div>
            </div>
