...
export const LoginPage = ({ className, ...props }: React.ComponentProps<"div">) => {
  ...
  const hangleLogin = async(event: FormEvent<HTMLFormElement>) => {
    ...
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      <Card className="overflow-hidden p-0">
        <CardContent className="grid p-0 md:grid-cols-2">
          <form className="p-6 md:p-8" onSubmit={hangleLogin}>
            <div className="flex flex-col gap-6">
              <div className="flex flex-col items-center text-center">
                <CustomLogo/>
                <p className="text-balance text-muted-foreground">Ingresa tu cuenta de la tienda</p>
              </div>
